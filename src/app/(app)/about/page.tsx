    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-headline animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">About PerfectFit</CardTitle>
        ...
        <CardContent className="space-y-12">
          <div className="relative h-64 w-full rounded-lg overflow-hidden">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold font-headline mb-4 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Our Story</h2>
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <h2 className="text-3xl font-bold font-headline mb-4 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Our Mission</h2>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold font-headline mb-6 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Our Core Values</h2>
