    ...
    <div className="space-y-8 animate-fade-in-up">
      <Card className="shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-headline text-rainbow">About PerfectFit</CardTitle>
        ...
        <CardContent className="space-y-12">
          <div className="relative h-64 w-full rounded-lg overflow-hidden">
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-3xl font-bold font-headline mb-4 text-rainbow">Our Story</h2>
           ...
           <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="md:order-1">
              <h2 className="text-3xl font-bold font-headline mb-4 text-rainbow">Our Mission</h2>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold font-headline mb-6 text-rainbow">Our Core Values</h2>
