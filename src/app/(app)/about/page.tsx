          ...
          <div className="grid md:grid-cols-3 gap-8 text-center pt-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Founded in 2025, PerfectFit was born from a desire to blend the timeless art of tailoring with the precision of modern technology. We believe everyone deserves to wear clothes that fit them perfectly.
              </p>
            </div>
            <div className="space-y-2">
