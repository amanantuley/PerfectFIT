...
export default function AboutUsPage() {
  return (
    <div className="space-y-20 sm:space-y-24 lg:space-y-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-fade-in-up">
      {/* Hero Section */}
      <section className="relative w-full h-[60vh] sm:h-[70vh] rounded-2xl overflow-hidden shadow-xl">
        <Image
          src="/about.webp"
        ...
        <CardContent className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center p-6 sm:p-10 lg:p-14">
          <div>
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              Founded in <strong>2025</strong>, PerfectFit emerged with one goal —
              to make custom-fit clothing accessible to everyone. We saw the
              frustration in ill-fitting clothes and knew technology could solve it.
              <br />
              <br />
      ...
      <Card className="shadow-xl overflow-hidden border border-gray-100/20 backdrop-blur-sm">
        <CardContent className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center p-6 sm:p-10 lg:p-14">
          <div className="relative w-full h-64 sm:h-80 md:h-full order-1 md:order-2">
            <Image
          ...
          <div className="order-2 md:order-1">
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              Our mission is to make <strong>AI-powered personalization</strong> the
              new normal. By reducing fabric waste, returns, and sizing frustration,
              PerfectFit is paving the way toward sustainable, inclusive fashion for all.
              <br />
              <br />
              Every stitch we create reflects our belief that the future of fashion is
              <strong> smart, sustainable, and personal.</strong>
            </p>
          </div>
        </CardContent>
      </Card>
