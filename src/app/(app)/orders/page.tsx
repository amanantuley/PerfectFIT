    ...
    <Card className="shadow-lg">
      ...
      <CardContent>
        <div className="rounded-md border overflow-x-auto">
            ...
            <TableHeader>
                <TableRow>
                <TableHead className="w-[100px] whitespace-nowrap">Order ID</TableHead>
            ...
            <TableBody>
                ...
                <TableRow key={order.id}>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <span className="font-medium whitespace-nowrap">{order.item}</span>
                    </div>
                    </TableCell>
                    ...
                    <TableCell className="text-right whitespace-nowrap">{order.date}</TableCell>
                </TableRow>
                ))}
            </TableBody>
            </Table>
