    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-4xl font-headline">Your Rewards</CardTitle>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold tracking-tight font-headline text-center">Available Rewards</h2>
