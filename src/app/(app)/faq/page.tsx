  ...
  return (
    <Card className="shadow-lg">
      <CardHeader className="text-center">
        ...
        <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Frequently Asked Questions</CardTitle>
        <CardDescription>
