...
const faqs = [
    {
        ...
        answer: "Our AI uses advanced computer vision algorithms to analyze the full-body photo you provide. It identifies key points on your body to estimate measurements like chest, waist, and inseam with high accuracy. The process is quick, secure, and eliminates the need for a physical measuring tape."
    },
    {
        question: "Is my photo and data secure?",
        answer: "Absolutely. We prioritize your privacy. Your photos are used only for the measurement extraction process and are not stored on our servers unless you explicitly choose to save them to your profile. All data is encrypted both in transit and at rest."
    },
    {
        question: "What is the difference between buying and renting?",
        answer: "Buying a garment means you own it. It's brand new and tailored to your size. Renting allows you to wear a garment for a specific period (e.g., a weekend event). It's a cost-effective and sustainable way to access a wide variety of styles without committing to a purchase."
    },
    {
