        ...
        <div className="flex justify-center items-center animate-fade-in-up" style={{ minHeight: 'calc(100vh - 200px)' }}>
            <Card className="shadow-lg text-center w-full max-w-md">
                <CardHeader>
                    ...
                    <CardTitle className="text-3xl text-transparent bg-clip-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-size-200 animate-text-rainbow">PerfectPay Wallet</CardTitle>
