  ...
  return (
    <Card className="w-full shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-headline">Get the PerfectFit App</CardTitle>
            ...
            <div className="flex justify-center gap-4">
                ...
                />
                 <Image 
                    ...
                    width={250}
                    height={500}
                    className="rounded-xl shadow-2xl transform rotate-6 hidden lg:block"
                    data-ai-hint="app interface"
                />
            </div>
            <div className="space-y-8">
                <div>
                    <h3 className="text-2xl font-bold mb-4">Your Ultimate Style Companion</h3>
