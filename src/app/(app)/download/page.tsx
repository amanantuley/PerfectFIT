  ...
  return (
    <Card className="w-full shadow-lg animate-fade-in-up">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-headline animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent bg-size-200">Get the PerfectFit App</CardTitle>
        ...
        <CardContent className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
                <div>
                    <h3 className="text-2xl font-bold mb-4 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent bg-size-200">Your Ultimate Style Companion</h3>
