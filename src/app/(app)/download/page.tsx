  ...
  return (
    <Card className="w-full shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-4xl font-headline animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Get the PerfectFit App</CardTitle>
        ...
        <CardContent className="grid md:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center">
                <Image 
                    ...
                    width={250}
                    height={500}
                    className="rounded-xl shadow-2xl transform md:-rotate-6"
            ...
            <div className="space-y-8">
                <div>
                    <h3 className="text-2xl font-bold mb-4 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Your Ultimate Style Companion</h3>
