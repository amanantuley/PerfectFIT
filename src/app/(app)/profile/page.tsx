  ...
  return (
    <div className="flex justify-center items-start">
       <Card className="w-full max-w-3xl shadow-lg">
        <CardHeader>
          <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">My Profile</CardTitle>
          <CardDescription>
            ...
            <form ref={formRef} action={formAction} className="space-y-6">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">Joined July 2025</p>
                    </div>
                </div>
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Address</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="street">Street Address</Label>
                            <Input id="street" name="street" placeholder="e.g. 123 Fashion Ave" />
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="city">City</Label>
                                <Input id="city" name="city" placeholder="e.g. Style City" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="zip" name="zip" placeholder="e.g. 10001" />
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Education</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="school">School/University</Label>
                            <Input id="school" name="school" placeholder="e.g. University of Design" />
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="degree">Degree</Label>
                                <Input id="degree" name="degree" placeholder="e.g. Bachelor's" />
                            </div>
                             <div className="space-y-2">
                                <Label htmlFor="fieldOfStudy">Field of Study</Label>
                                <Input id="fieldOfStudy" name="fieldOfStudy" placeholder="e.g. Fashion Design" />
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Change Password</CardTitle>
