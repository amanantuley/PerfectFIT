  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 animate-fade-in-up">
       <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-rainbow bg-size-200 animate-text-rainbow">Contact Information</CardTitle>
          <CardDescription>
       ...
       <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-rainbow bg-size-200 animate-text-rainbow">Send us a Message</CardTitle>
          <CardDescription>
