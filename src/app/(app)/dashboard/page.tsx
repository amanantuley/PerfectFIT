...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
           ...
           <Tabs defaultValue="live" className="w-full">
              ...
              <TabsContent value="live">
                <Card className="shadow-lg mt-2">
                  <CardHeader>
                    <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Live Measurement</CardTitle>
              ...
              <TabsContent value="upload">
                <Card className="shadow-lg mt-2">
                  <CardHeader>
                    <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">AI Measurement</CardTitle>
        ...
        <div className="xl:col-span-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Your Measurements</CardTitle>
            ...
            <Card className="shadow-lg">
                <CardHeader>
                    <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Digital Mannequin</CardTitle>
      ...
      <div>
        <h2 className="text-2xl font-bold tracking-tight font-headline animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">
