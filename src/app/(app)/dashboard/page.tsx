...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
           ...
           <Tabs defaultValue="live" className="w-full">
              ...
              <TabsContent value="live">
                <Card className="shadow-lg mt-2">
                  <CardHeader>
                    <CardTitle className="text-rainbow">Live Measurement</CardTitle>
              ...
              <TabsContent value="upload">
                <Card className="shadow-lg mt-2">
                  <CardHeader>
                    <CardTitle className="text-rainbow">AI Measurement</CardTitle>
        ...
        <div className="xl:col-span-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-rainbow">Your Measurements</CardTitle>
            ...
            <Card className="shadow-lg">
                <CardHeader>
                    <CardTitle className="text-rainbow">Digital Mannequin</CardTitle>
      ...
      <div>
        <h2 className="text-2xl font-bold tracking-tight font-headline text-rainbow">
