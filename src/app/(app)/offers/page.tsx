  ...
  return (
    <div className="space-y-8 animate-fade-in-up">
      <div className="text-center">
        <h1 className="text-4xl font-bold font-headline text-rainbow bg-size-200 animate-text-rainbow">Exclusive Offers</h1>
        ...
        {offers.map((offer) => (
          <Card key={offer.title} className="flex flex-col shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader className="flex-row gap-4 items-center">
                ...
                <div>
                    <CardTitle className="text-rainbow bg-size-200 animate-text-rainbow">{offer.title}</CardTitle>
