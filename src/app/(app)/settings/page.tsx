...
export default function SettingsPage() {
  ...
  return (
    ...
    <Card className="w-full max-w-2xl shadow-lg">
        <CardHeader>
        <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent bg-size-200">Settings</CardTitle>
        <CardDescription>
