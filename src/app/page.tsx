...
import { Camera, Scissors, Ruler, Bot, Users, Star, Shirt, Award, Facebook, Twitter, Instagram, Linkedin, Sparkles, Wand2, Lightbulb, Quote, LogIn } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center shadow-sm sticky top-0 z-50 bg-background/90 backdrop-blur-sm">
        ...
        <nav className="ml-10 hidden lg:flex gap-4 sm:gap-6 items-center">
            <Link href="#features" className="text-sm font-medium hover:text-primary transition-colors underline-offset-4">Features</Link>
            <Link href="#how-it-works" className="text-sm font-medium hover:text-primary transition-colors underline-offset-4">How it Works</Link>
            <Link href="#team" className="text-sm font-medium hover:text-primary transition-colors underline-offset-4">Team</Link>
            <Link href="#testimonials" className="text-sm font-medium hover:text-primary transition-colors underline-offset-4">Testimonials</Link>
        </nav>
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:gap-8">
              <div className="flex flex-col justify-center space-y-4">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none font-headline animate-fade-in-up text-gradient animate-rainbow">
                  The Future of Tailoring is Here.
                </h1>
                <p className="max-w-[600px] text-foreground/80 md:text-xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/40">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline text-gradient animate-rainbow">Why Choose PerfectFit?</h2>
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              ...
              <div className="grid gap-2 text-center p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
                 <div className="mx-auto bg-primary/10 p-3 rounded-full mb-2">
              ...
              <div className="grid gap-2 text-center p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
                <div className="mx-auto bg-primary/10 p-3 rounded-full mb-2">
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3 flex flex-col items-center">
              ...
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight font-headline text-gradient animate-rainbow">Three Simple Steps to a Perfect Fit</h2>
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="mx-auto w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8 pt-8">
              ...
              <div className="flex flex-col items-center space-y-4 p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex flex-col items-center space-y-4 p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
        ...
        {/* Team Section */}
        <section id="team" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/40">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                    <div className="inline-flex rounded-lg bg-muted px-3 py-1 text-sm font-semibold tracking-wide items-center gap-2">
                    ...
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline text-gradient animate-rainbow">The Minds Behind the Fit</h2>
                    <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 sm:grid-cols-3">
                    ...
                    <div className="flex flex-col items-center text-center p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                         <Image className="rounded-full mb-4" src="https://placehold.co/128x128.png" alt="Team member" width={128} height={128} data-ai-hint="person avatar"/>
                    ...
                    <div className="flex flex-col items-center text-center p-4 rounded-lg transition-transform duration-300 hover:scale-105 hover:bg-card hover:shadow-xl animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                         <Image className="rounded-full mb-4" src="https://placehold.co/128x128.png" alt="Team member" width={128} height={128} data-ai-hint="person avatar"/>
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
             <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline text-gradient animate-rainbow">What Our Customers Say</h2>
               <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="p-6 rounded-lg border bg-card text-card-foreground transition-all duration-300 hover:shadow-xl hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                     <div className="flex items-center gap-2 mb-4">
                        <Star className="w-5 h-5 fill-primary text-primary" />
                        <Star className="w-5 h-5 fill-primary text-primary" />
                        <Star className="w-5 h-5 fill-primary text-primary" />
                ...
                <div className="p-6 rounded-lg border bg-card text-card-foreground transition-all duration-300 hover:shadow-xl hover:-translate-y-1 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                     <div className="flex items-center gap-2 mb-4">
                        <Star className="w-5 h-5 fill-primary text-primary" />
                        <Star className="w-5 h-5 fill-primary text-primary" />
                        <Star className="w-5 h-5 fill-primary text-primary" />
        ...
        {/* Newsletter Section */}
        <section id="newsletter" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/40">
            <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
                <div className="space-y-3 flex flex-col items-center">
                    <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight font-headline text-gradient animate-rainbow">Stay in the Loop</h2>
                    <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                        Subscribe to our newsletter for the latest styles, offers, and updates from PerfectFit.
                    </p>
                </div>
                <div className="mx-auto w-full max-w-sm space-y-2 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
             ...
             <div>
                ...
                <ul className="space-y-2">
                    <li><Link href="/dashboard" className="text-sm hover:text-primary transition-colors">AI Measurement</Link></li>
                    <li><Link href="/subscription" className="text-sm hover:text-primary transition-colors">Subscriptions</Link></li>
                    <li><Link href="/rewards" className="text-sm hover:text-primary transition-colors">Rewards</Link></li>
                </ul>
            </div>
            <div>
                ...
                <ul className="space-y-2">
                    ...
                    <li><Link href="/returns" className="text-sm hover:text-primary transition-colors">Return Policy</Link></li>
                </ul>
            </div>
        </div>
