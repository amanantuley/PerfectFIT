          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:gap-8">
              <div className="flex flex-col justify-center space-y-4">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none font-headline animate-fade-in-up bg-clip-text text-transparent bg-gradient-to-r from-primary via-destructive to-yellow-400 bg-size-200 animate-rainbow">
