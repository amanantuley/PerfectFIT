          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:gap-8">
              <div className="flex flex-col justify-center space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tighter font-headline animate-fade-in-up bg-clip-text text-transparent bg-gradient-to-r dark:from-primary dark:via-destructive dark:to-yellow-400 from-brown-600 via-brown-400 to-brown-600 bg-size-200 animate-rainbow">
        ...
        <section id="vision" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/40">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12 animate-fade-in-up">
                    ...
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline">A New Era of Personal Style</h2>
