        ...
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex gap-3 sm:gap-4">
                    <Link href="https://www.facebook.com/profile.php?id=61579391364648" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', padding: '0.5rem', borderRadius: '0.5rem', background: 'rgba(255, 255, 255, 0.05)', transition: 'all 300ms'}}>
                        <FacebookIcon />
                    </Link>
                    <Link href="https://www.instagram.com/perfectfit_ai?igsh=ZmYzeXlsYXp0bW04" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', padding: '0.5rem', borderRadius: '0.5rem', background: 'rgba(255, 255, 255, 0.05)', transition: 'all 300ms'}}>
                        <InstagramIcon />
                    </Link>
                    <a href="#" style={{display: 'inline-flex', padding: '0.5rem', borderRadius: '0.5rem', background: 'rgba(255, 255, 255, 0.05)', transition: 'all 300ms'}}>
                        <TwitterIcon />
                    </a>
                    <Link href="https://www.linkedin.com/company/perfectfit-ai/" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', padding: '0.5rem', borderRadius: '0.5rem', background: 'rgba(255, 255, 255, 0.05)', transition: 'all 300ms'}}>
                        <LinkedinIcon />
                    </Link>
                </div>
            </div>
