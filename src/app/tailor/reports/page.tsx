    ...
    return (
        <div className="space-y-8 animate-fade-in-up">
             <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-rainbow">{t('Reports')}</h1>
            ...
            <div className="grid gap-8 lg:grid-cols-5">
                ...
                <Card className="lg:col-span-3">
                    <CardHeader>
                        <CardTitle className="text-rainbow">{t('Monthly Sales')}</CardTitle>
                ...
                <Card className="lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="text-rainbow">{t('Order by Category')}</CardTitle>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-rainbow">{t('Top Performing Designs')}</CardTitle>
