  ...
  return (
    <div className="flex justify-center items-start animate-fade-in-up">
       <Card className="w-full max-w-3xl shadow-lg">
        <CardHeader>
          <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent bg-size-200">{t('Tailor Profile')}</CardTitle>
          <CardDescription>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex flex-col sm:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 space-y-1 text-center sm:text-left">
                        <h3 className="text-xl font-bold flex items-center justify-center sm:justify-start gap-2">John "The Stitch" Doe <Verified className="h-5 w-5 text-blue-500"/></h3>
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><SewingPinIcon /> {t('My Specialties')}</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                         <div className="space-y-2">
                            <Label htmlFor="specialties">{t('Specialties (comma-separated)')}</Label>
                            <Input id="specialties" name="specialties" placeholder={t('e.g. Wedding Suits, Business Attire, Custom Shirts')} defaultValue="Bespoke Suits, Wedding Attire, Vintage Clothing Repair, Custom Shirts" />
                        </div>
                         <div className="flex items-center space-x-2">
                            <Switch id="rush-orders" />
                            <Label htmlFor="rush-orders">{t('Accept Rush Orders')}</Label>
                        </div>
                    </CardContent>
                </Card>
                 ...
                 <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><Landmark /> {t('Banking Information')}</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input id="bank-name" name="bankName" placeholder={t('e.g. Global Trust Bank')} />
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="routing-number">{t('Routing Number')}</Label>
                                <Input id="routing-number" name="routingNumber" placeholder={t('e.g. 123456789')} />
                            </div>
                             <div className="space-y-2">
                                <Label htmlFor="account-number">{t('Account Number')}</Label>
                                <Input id="account-number" name="accountNumber" placeholder={t('e.g. 987654321')} />
                            </div>
                        </div>
                    </CardContent>
                </Card>
