        ...
        <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><SewingPinIcon /> My Specialties</CardTitle>
                    </CardHeader>
                 ...
                 <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><Landmark /> Banking Information</CardTitle>
