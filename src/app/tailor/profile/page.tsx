...
import { Loader2, Camera, Star, Verified, Bank, SewingPin } from 'lucide-react';
        ...
        <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><SewingPin /> My Specialties</CardTitle>
                    </CardHeader>
                 ...
                 <Card className="bg-muted/30">
                    <CardHeader>
                        <CardTitle className="text-xl flex items-center gap-2"><Bank /> Banking Information</CardTitle>
