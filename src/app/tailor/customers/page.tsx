    ...
    return (
        <Card className="animate-fade-in-up">
            <CardHeader className="flex flex-row items-center justify-between">
                <div>
                    <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent bg-size-200">Customers</CardTitle>
                    <CardDescription>
                        ...
                        <CardContent className="p-4 flex gap-4">
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex items-center">
                                    <Badge variant="secondary">Orders: {customer.orders}</Badge>
                                </div>
                            </div>
                            <DropdownMenu>
