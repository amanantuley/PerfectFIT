...
export default function TailorOrdersPage() {
  return (
    <Card className="animate-fade-in-up">
      <CardHeader>
        <CardTitle className="animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Manage Orders</CardTitle>
