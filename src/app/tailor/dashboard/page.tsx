...
export default function TailorDashboard() {
  return (
    <div className="space-y-6 relative pb-20">
      <h1 className="text-3xl font-bold animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Dashboard</h1>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-orange-500">Today's Earnings</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-orange-500">Orders this Week</CardTitle>
            <ClipboardList className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">+12</div>
            <p className="text-xs text-muted-foreground">
              5 pending, 7 in progress
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-orange-500">New Customers</CardTitle>
         ...
         <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-orange-500">Upcoming Fittings</CardTitle>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        <Card className="lg:col-span-3">
          <CardHeader>
            <CardTitle className="text-orange-500 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Earnings Overview</CardTitle>
            <CardDescription>
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-orange-500 animate-text-rainbow bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Recent Orders</CardTitle>
            <CardDescription>
            ...
            <Table>
              ...
              <TableBody>
                {recentOrders.map((order) => {
                  ...
                  return (
                    <TableRow key={order.orderId} className="bg-yellow-50 dark:bg-yellow-900/20">
                      <TableCell>
