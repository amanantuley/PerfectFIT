...
export default function TailorDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      <h1 className="text-3xl font-bold text-rainbow bg-size-200 animate-text-rainbow">{t('Dashboard')}</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle className="text-rainbow bg-size-200 animate-text-rainbow">{t('Recent Orders')}</CardTitle>
            <CardDescription>
